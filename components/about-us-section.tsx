  ...
  return (
    <div className="space-y-16">
      {sections.map((section, index) => (
        <section key={section.id} className={variant === "default" ? "section-padding" : "py-12"}>
          <div className="max-w-7xl mx-auto container-padding">
            ...
            >
              ...
              >
                <h2
                  className={`${variant === "default" ? "text-3xl md:text-4xl" : "text-2xl md:text-3xl"} font-bold mb-6`}
                >
                  {section.title}
                </h2>
